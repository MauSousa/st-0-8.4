...
static char *font = "Fira code:pixelsize=16.5:antialias=true:autohint=true";
...
#define MYKEY (ControlMask|Mod1Mask)
...
static Shortcut shortcuts[] = {
  ...
  { MYKEY,                XK_k,           kscrollup,      {.i = +1} },
  { MYKEY,                XK_j,           kscrolldown,    {.i = +1} },
};
